...
The project-specific information and technical details are maintained in the referenced documentation files.

@.claude/memory/project/project-structure.md

## Coding Guidelines

When editing files, Claude must follow the established coding standards and formatting guidelines for consistency and quality.
